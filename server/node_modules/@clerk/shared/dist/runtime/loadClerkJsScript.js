...
const require_versionSelector = require('./versionSelector-DaSp8kgb.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.13.1");
